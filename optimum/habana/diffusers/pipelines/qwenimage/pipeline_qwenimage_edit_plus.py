...
class GaudiQwenImageEditPlusPipeline(GaudiDiffusionPipeline, QwenImageEditPlusPipeline):
    ...
    def __init__(
        ...
        if use_hpu_graphs:
            ...
            logger.warning("GaudiQwenImageEditPlusPipeline HPU graph mode may have OOM problem when image size changes. So changed to use_hpu_graphs=False !")
        ...
        self.transformer.hidden_states_buckets = [8272,12408]
        self.transformer.encoder_hidden_states_buckets =[256,512]
